...
namespace GaragensDR.Infra.Shared.Bases
{
    public class Events
    {
        ...
        public static readonly Event ERROR_USER_FORMAT_WRONG = new Event(nameof(ERROR_USER_FORMAT_WRONG), "NomeUsuario precisa ser apenas número.");
        ...
        public static readonly Event ERROR_AUTHENTICATE_USER_NOT_ACTIVATED = new Event(nameof(ERROR_AUTHENTICATE_USER_NOT_ACTIVATED), "Usuário não ativado");
        ...
        public static readonly Event ERROR_CHANGE_PASSWORD_INVALID_FORMAT = new Event(nameof(ERROR_CHANGE_PASSWORD_INVALID_FORMAT), "A senha deve conter no mínimo 8 e no máximo 32 caracteres, sendo letras, números e caracteres especiais");
        ...
        public static readonly Event GET_NOT_FOUND = new Event(nameof(GET_NOT_FOUND), "Não foi possível localizar o registro, {0}.");
        ...
        public static readonly Event EXIST_PROPERTY_GENERIC = new Event(nameof(EXIST_PROPERTY_GENERIC), "A propriedade '{0}' já possui o valor '{1}' cadastrado.");
        public static readonly Event EXIST_ENTITY_GENERIC = new Event(nameof(EXIST_PROPERTY_GENERIC), "Já existe um registro cadastrado para {0}.");
    }
    public struct Event
    {
